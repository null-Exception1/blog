...
So take a window of $$\mathbf{W}$$ consecutive hidden states, stack them as rows into a matrix $$\mathbf{H}$$, and build what I started calling the **temporal Gram matrix**:
